...
print(area(height:4, width:10))

func peri (side1: Double, side2: Double, side3: Double, side4: Double) -> Double {
    return (side1 + side2 + side3 + side4)
}
print(peri(side1:5, side2:5, side3:5, side4:5))

func irregular(_ internalArray: [Double]) -> Double {
...
let walls : [Double] = [10.10, 22.06, 30.01, 70.04, 90.01]
print(irregular(walls))
